...
1. Variables (`$primary-color`)  
   Cho phép đặt các giá trị thuộc tính vào một biến bằng cách khai báo `$tên-biến`.
...
2. Nesting (viết CSS lồng nhau)  
   sử dụng cấu trúc lồng ghép như html giúp trực quan
...
3. Mixins (`@mixin`, `@include`)  
    Hoạt động như một hàm CSS, cho phép tái sử dụng nhiều lần
...
4. `@extend` / Inheritance  
    Cho phép selector kế thừa những thuộc tính được thiết lập ở selector khác, bản chất đó là nó đưa selector được `@extend` vào chung với selector gốc trong file CSS cuối
